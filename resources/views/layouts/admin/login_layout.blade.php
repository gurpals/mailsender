...
<head>
  ...
  <link rel="stylesheet"
    href="{{asset('https://fonts.googleapis.com/css?family=Montserrat:300,300i,400,400i,500,500i%7COpen+Sans:300,300i,400,400i,600,600i,700,700i')}}">
  <!-- BEGIN: Vendor CSS-->
...
<body class="vertical-layout vertical-menu 1-column  bg-full-screen-image blank-page blank-page" data-open="click"
  ...
  <script src="{{asset('admin/css/vendors/js/forms/validation/jqBootstrapValidation.js')}}"></script>
  ...
  <!-- BEGIN: Page JS-->
  <script src="{{asset('admin/css/js/scripts/forms/form-login-register.js')}}"></script>
</body>
</html>