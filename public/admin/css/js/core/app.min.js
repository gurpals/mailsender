! function(e, n, a) {
    ...
    if (a(e).on("load", (function() {
            ...
            var i = s.data("menu");
            "horizontal-menu" != i && !1 === e && a(".main-menu-content").find("li.active").parents("li").addClass("open"), "horizontal-menu" == i && (a(".main-menu-content").find("li.active").parents("li:not(.nav-item)").addClass("open"), a(".main-menu-content").find("li.active").parents("li").addClass("active")), !0 === e && a(".main-menu-content").find("li.active").parents("li").addClass("menu-collapsed-open"), a(".heading-elements-toggle").on("click", (function() { a(this).parent().children(".heading-elements").toggleClass("visible") }));
            var o = a(".chartjs"),
    ...
    a(n).on("click", ".menu-toggle, .modern-nav-toggle", (function(n) { return n.preventDefault(), a.app.menu.toggle(), setTimeout((function() { a(e).trigger("resize") }), 200), a("#collapsed-sidebar").length > 0 && setTimeout((function() { s.hasClass("menu-expanded") || s.hasClass("menu-open") ? a("#collapsed-sidebar").prop("checked", !1) : a("#collapsed-sidebar").prop("checked", !0) }), 1e3), a(".vertical-overlay-menu .navbar-with-menu .navbar-container .navbar-collapse").hasClass("show") && a(".vertical-overlay-menu .navbar-with-menu .navbar-container .navbar-collapse").removeClass("show"), !1 })), a(n).on("click", ".main-menu-footer .footer-toggle", (function(e) { return e.preventDefault(), a(this).find("i").toggleClass("pe-is-i-angle-down pe-is-i-angle-up"), a(".main-menu-footer").toggleClass("footer-close footer-open"), !1 })), a(".navigation").find("li").has("ul").addClass("has-sub"), a(".carousel").carousel({ interval: 2e3 }), a(".nav-link-expand").on("click", (function(e) { "undefined" != typeof screenfull && screenfull.isEnabled && screenfull.toggle() })), "undefined" != typeof screenfull && screenfull.isEnabled && a(n).on(screenfull.raw.fullscreenchange, (function() { screenfull.isFullscreen ? a(".nav-link-expand").find("i").toggleClass("icon-minimize icon-maximize") : a(".nav-link-expand").find("i").toggleClass("icon-maximize icon-minimize") })), a(n).on("click", ".mega-dropdown-menu", (function(e) { e.stopPropagation() })), a(n).ready((function() {
    ...
    })), a(e).resize((function() { a.app.menu.manualScroller.updateHeight() })), a(".nav.nav-tabs a.dropdown-item").on("click", (function() {
        var e = a(this),
            n = e.attr("href"),
            t = e.closest(".nav");
        ...
        var n = a(this),
            t = n.attr("href"),
            s = a(t).offset().top - 80;
        a("html, body").animate({ scrollTop: s }, 0), setTimeout((function() { n.parent(".nav-item").siblings(".nav-item").children(".nav-link").removeClass("active"), n.addClass("active") }), 100)
    })), i18next.use(e.i18nextXHRBackend).init({ debug: !1, fallbackLng: "en", backend: { loadPath: "app-assets/data/locales/{{lng}}.json" }, returnObjects: !0 }, (function(e, n) { jqueryI18next.init(i18next, a) })), a(".dropdown-language .dropdown-item").on("click", (function() {
        var e = a(this);
        ...
        i18next.changeLanguage(s, (function(e, n) { a(".main-menu , .horizontal-menu").localize() }))
    }));
